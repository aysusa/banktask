...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        BankAccount Fatma = new BankAccount(444, "fatma", 555);
        kapital.Add(Fatma);
        BankAccount aysu = new BankAccount(1919, "aysu", 10000);
        kapital.Add(aysu);
        ...
        switch (MainMenu)
        {
            ...
            case 2:
                ...
                kapital.Add(new BankAccount(accuntNumber, ownerName, Balance));
                break;
            case 3:
